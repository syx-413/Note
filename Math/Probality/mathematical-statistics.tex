...
\paragraph{\boxed{\text{无偏性}}}

$E\hat{\theta}=\theta$。

\paragraph{\boxed{\text{有效性}}}

$D\hat{\theta_1}<D\hat{\theta_2}$。

\paragraph{\boxed{\text{一致性}}}

\subsection{置信区间}

\paragraph{\boxed{\text{方差已知}}}
