...
\paragraph{\boxed{\text{高阶线性微分方程}}}

% \paragraph{常系数齐次线性微分方程}

% \paragraph{常系数非齐次线性微分方程}
...
\paragraph{\boxed{\text{欧拉方程}}}

\paragraph{\boxed{\text{微分方程物理应用}}}
