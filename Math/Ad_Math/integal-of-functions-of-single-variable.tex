...
\subsection{不定积分（基本积分、换元积分、分部积分、有理积分、
不定积分等式）}
\paragraph{\boxed{\text{基本积分}}}
...
\paragraph{\boxed{\text{换元积分}}}

\subsubsection{第一类换元}

\paragraph{\boxed{\text{凑微分法}}} \leavevmode \medskip
...
\paragraph{\boxed{\text{积化和差}}} \leavevmode \medskip
...
\paragraph{\boxed{\text{三角等式}}} \leavevmode \medskip
...
\paragraph{\boxed{\text{反三角换元}}} \leavevmode \medskip
...
\paragraph{\boxed{\text{有理换元}}} \leavevmode \medskip
...
\paragraph{\boxed{\text{万能公式}}} \leavevmode \medskip
...
\paragraph{\boxed{\text{辅助换元}}} \leavevmode \medskip
...
\paragraph{\boxed{\text{非幂函数优先} }}\leavevmode \medskip
...
\paragraph{\boxed{\text{幂函数优先}}} \leavevmode \medskip
...
\subsection{定积分（换元积分、分部积分、极限化为定积分、定限积分等式、定积分不等式、中值定理）}
...
\paragraph{\boxed{\text{无穷小比较}}}

当对变限积分进行无穷小进行比较时有这样的结论：

\textcolor{orange}{\textbf{定理：}}若$f(x)$在$x=0$的某邻域内连续，且$x\to0$时，$f(x)$是$x$的$m$阶无穷小，$\varphi(x)$是$x$的$n$阶无穷小，则当$x\to0$时$F(x)=\int_0^{\varphi(x)}f(t)\,\textrm{d}t$是$x$的$n(m+1)$阶无穷小。
...
\paragraph{\boxed{\text{参数方程}}} \leavevmode \medskip
...
\paragraph{\boxed{\text{极坐标}}} \leavevmode \medskip
...
\paragraph{\boxed{\text{旋转体侧面积}}} \leavevmode \medskip

\subsubsection{体积}

\paragraph{\boxed{\text{旋转体}}} \leavevmode \medskip
...
\paragraph{\boxed{\text{平行截面已知的立体体积} }}\leavevmode \medskip
...
\subsection{积分关系式（函数单调性、拉格朗日中值定理、泰勒公式）}

基本上要使用到积分中值定理。

\paragraph{\boxed{\text{积分等式}}}
